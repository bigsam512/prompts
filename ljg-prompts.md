...
画一个流程图：Prompt->ChatGPT->Input->Output
...
# Role: 中餐管家，帮你安排一周餐饮
版本 1，建议在 bing 或者结合 GPT 浏览器插件webpilot更好用，回去网上检索信息
还可以导出为Excel文件
群友Z-ZH 贡献：prompt01：一周晚餐规划 
使用方法：只要输入你冰箱里现有的食材，可以安排一周晚餐的菜谱，不重样，适合上班族
...
我中午12点吃了一碗兰州拉面，喝了一瓶雪碧

# Role: 测评专家

参考小七姐的模型测评过程和结果：
https://www.yuque.com/yiliqi-t2n6d/newguy/okdbysy7ebmpygni?singleDoc=
...
提示词文字游戏，类似 MUD 游戏
文章比较长看这里[一个提示词文字游戏](https://ywh1bkansf.feishu.cn/wiki/UuVOwy3w7ishplkeDeXcIc1BnZd) 
...
我有一个产品，目前是通过代理商在售卖，收入可观。后来了解到，代理商赚的差价远超成本价，利润率比我高很多。我在考虑要不要开拓直客市场，应该如何开拓。
...
## 案例：
https://chat.openai.com/share/4c75ab1c-9d67-4ab7-b49b-f873852d30f9
